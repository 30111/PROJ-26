...
function keyPressed() {
	if (keyCode === UP_ARROW) {
    //ESCREVA UM CÓDIGO CORRETO PARA APLICAR UMA TECLA PRESSIONADA PARA MUDAR A POSIÇÃO DO OBJETO ESFERA PARA A ESQUERDA QUANDO A TECLA DE SETA PARA CIMA É PRESSIONADA
